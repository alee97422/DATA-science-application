...
def generate_visualizations():
    ...
    if selected_column_1 != "Select Column" and selected_column_2 != "Select Column":
        if csv_data:
            ...
            max_data_points_col1 = int(max_data_points_col1_entry.get())
            max_data_points_col2 = int(max_data_points_col2_entry.get())
            ...
            if selected_column_3 != "Select Column":
                max_data_points_col3 = int(max_data_points_col3_entry.get())
